...
function GroupSubtractIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
      width="24"
      height="24"
      ...
      {...props}
    >
      <g clip-path="url(#clip0_6858_3071)">
        <path
        ...
        />
        <path
          d="M19.9825 17.9614L16.4074 17.9614"
          stroke="currentColor"
          strokeLinecap="round"
        />
        <circle
